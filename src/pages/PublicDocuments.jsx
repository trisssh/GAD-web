...
export default function PublicDocuments() {
  ...
  const documentType = searchParams.get("type") || "sector"; // default to sector
  ...
  return (
    <>
      <div className="font-extrabold text-2xl text-gray-800 mb-3 p-4">
        Public Documents
      </div>
...
function InputSection({
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 w-full bg-red px-5">
      {documentType === "sector" ? (
        <>
          {/* Sector */}
